...
class Seq():
    def __init__(self,seq_imgs,labels_list,preproc = None,
            ids_list = [],all_imgs = None,ignored_regions=None,mode = 'train'):
    ...
    def _load_data(self,index):
        ...
        if self.mode in ['val','eval','evaluate']:
        ...
        for video in self.all_annonations:
            ...
            for frame in frames:
                ...
                if len(img_filenames) >= self.seq_len:
                    seqs_map.append(Seq(img_filenames,labels_list,self.preproc,ids_list,all_imgs = self.all_imgs,ignored_regions=ignored_regions,mode = self.mode))
                    labels_list = []
                    img_filenames = []
                    ids_list = []
                ...
                if self.mode in ['val'] and 'img_id' in frame.keys():
